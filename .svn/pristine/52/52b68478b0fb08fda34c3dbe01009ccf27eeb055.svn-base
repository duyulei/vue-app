<template>
  <div class="company-view" :class="wechatHeader ? 'wechat-header' : ''" v-loading.body="loading">
    <x-header v-if="!wechatHeader" class="header" :left-options="{backText: ''}">公司详情</x-header>
    <div class="logo-box">
