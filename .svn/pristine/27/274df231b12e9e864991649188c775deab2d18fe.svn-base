<template>
  <div id="root" class="resume-view">
    <x-header v-if="isLoading" class="header" @touchmove.prevent :left-options="{backText: ''}" :right-options="{showMore: true}" @on-click-more="shareShowClick">
    ...
    <div class="content" v-if="isLoading" :class="isShowMenu ? 'band-class' : ''">
      <!--基本信息-->
      <div id="basicInfoValue" v-if="resume.basicInfoValue" class="ui-card container-fluid ui-card-info">
        ...
        <div class="header-info">
          ...
          <div class="container-fluid base-info-list">
            ...
            <div class="col-xs-6 item item-center" v-if="resume.basicInfoValue.politicsStatusView">
              <i class="iconfont left-icon ui-label icon-icon22"></i>
      ...
      <!--职业意向-->
      <div id="jobIntentionValue" class="ui-card container-fluid">
        ...
        <div v-else>
          ...
          <div class="job-add" @click="goJobEditView">
            <i slot="right" style=" font-size: 25px;color: #D86471;" class="iconfont icon-jia7"></i>
          </div>
        </div>
      </div>
      <!--教育情况-->
      <div id="eduBgdValue" class="ui-card container-fluid">
        <div v-if="resume.eduBgdValue">
          ...
          <div class="container-fluid edu-box">
            ...
            <div style="display: inline-block;" class="item" v-if="resume.eduBgdValue.offerList">
              <div class="ui-label offer-label">知名公司offer：</div>
              <div class="offer-list" v-for="offer in resume.eduBgdValue.offerList">{{offer}}
              </div>
            </div>
          </div>
        ...
        <div v-else>
          ...
          <div class="edu-add" @click="goEduAdd">
            <i slot="right" style=" font-size: 25px;color: #D86471" class="iconfont icon-jia7"></i>
          </div>
        </div>
      </div>
      <!--工作情况-->
      <div id="workExpValueList" v-if="resume.workStateValue.workExpValueList" class="ui-card container-fluid">
        <div class="control">
          <span>工作经历</span>
      ...
      <!--项目经验-->
      <div id="projExpValueList" v-if="resume.workStateValue.projExpValueList" class="ui-card container-fluid">
        <div class="control">
          <span>项目经验</span>
      ...
      <!--技能特长-->
      <div id="skillsSpclValueList" v-if="resume.skillsStateValue && resume.skillsStateValue.skillsSpclValueList"
      ...
      <!--证书-->
      <div id="skillsCertValueList" v-if="resume.skillsStateValue && resume.skillsStateValue.skillsCertValueList"
           class="ui-card container-fluid">
        <div class="control">
          <span>证书</span>
          ...
          <div class="flex-box" v-for="(skillsCertValue,index) in resume.skillsStateValue.skillsCertValueList"
            ...
            <div class="flex-box-content">
              ...
              <div class="certificate"><span class="time">{{skillsCertValue.getTime}}</span><span
                class="label-red">{{skillsCertValue.customName}}{{skillsCertValue.certName}}</span><span
                class="score">{{skillsCertValue.achievement}}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <!--培训经历-->
      <div id="skillsTrnValueList" v-if="resume.skillsStateValue && resume.skillsStateValue.skillsTrnValueList"
           class="ui-card container-fluid">
        <div class="control">
          <span>培训经历</span>
      ...
      <!--附件-->
      <div id="affixInfoValue" v-if="resume.affixInfoValue" class="ui-card container-fluid">
        <div class="control">
          <span>附件</span>
    ...
    <actionsheet v-model="shareShow" :menus="shareMenu"></actionsheet>
  </div>
...
<style scoped>
  ...
  .band-class{
    position: relative;
    animation:myfirst .38s;
    /* Firefox: */
    -moz-animation:myfirst .38s;
    /* Safari and Chrome: */
    -webkit-animation:myfirst .38s;
    /* Opera: */
    -o-animation:myfirst .38s;
    left: -50%;
    }
