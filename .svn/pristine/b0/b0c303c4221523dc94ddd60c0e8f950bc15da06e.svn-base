<template>
  <div class="project-edit">
    ...
    <group class="basic-info">
        ...
        <popup-radio class="user-defined company-name" title="公司名称" :options="coNames" v-model="form.workExpId" placeholder="请选择公司名称"></popup-radio>
  ...
  export default {
    ...
    created() {
      if (this.$route.query.projExpId){
        ...
        if (this.$store.state.resume.resume.workStateValue.projExpValueList[this.index].endTime === '至今'){
          this.form.endTime = ''
        } else {
