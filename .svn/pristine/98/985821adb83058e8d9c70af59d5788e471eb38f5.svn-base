<template>
  <div class="fund-detail" :class="wechatHeader ? 'wechat-header' : ''">
    <x-header v-if="!wechatHeader" class="header" :left-options="{backText: ''}">收支详情</x-header>
    <group>
      ...
      <cell title="介绍" :value="explain"></cell>
