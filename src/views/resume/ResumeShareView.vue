<template>
  <div id="root" class="resume-view">
    <resume-share-menu v-model="isShowMenu" @select-type="onSelectType" @affix-click="affixClick"
                 :resume="resume"></resume-share-menu>
    <div class="content" v-if="isLoading">
      <!--基本信息-->
      <div id="basicInfoValue" v-if="resume.basicInfoValue" class="ui-card container-fluid ui-card-info">
      <i @click="showMenu" style="font-size: 25px;color: #FFF;position: absolute;z-index: 1;right: 15px;top: 10px;" class="iconfont icon-menu"></i>
        ...
        <div class="header-info">
          ...
          <div class="base-info ">
            <div v-if="resume.basicInfoValue.workStateView">目前状态：{{resume.basicInfoValue.workStateView}}</div>
          </div>
...
<script scoped>
  ...
  import ResumeShareMenu from '../../components/ResumeShareMenu'
  ...
  export default {
    ...
    components: {ModelTitle, PopupItem, Loading, ResumeShareMenu, Popup, Group, XHeader, Actionsheet},
    computed: mapState({
