<template>
  <div class="user">
    <div class="setting"><i @click="goSetting()" style="color: #d86372; font-size:25px;" slot="icon"
                            class="iconfont icon-settings"></i></div>
    ...
    <group>
      ...
      <popup-radio title="目前状态" v-if="workState" :options="status" v-model="workState"></popup-radio>
    </group>
    <group>
