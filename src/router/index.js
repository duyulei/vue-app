...
export default new Router({
  ...
  routes: [
    ...
    },
    {
      path: '/resume/share',
      name: '简历分享',
      component: resolve => require(['@/views/resume/ResumeShareView.vue'], resolve),
      meta: {
        keepAlive: false,
        requireAuth: true
      }
    ...
    },
    {
      path: '/home/ability',
      name: '顾指数',
      component: resolve => require(['@/views/home/AbilityView.vue'], resolve),
      meta: {
        keepAlive: true,
        requireAuth: true
      }
    ...
    {
      path: '/user/setting/account/resetemailone',
      name: '更换邮箱',
      component: resolve => require(['@/views/user/ResetEmailOneView.vue'], resolve),
      meta: {
        keepAlive: false,
        requireAuth: true
      }
    ...
    {
      path: '/user/setting/account/resetemailtwo',
      name: '确认更换邮箱',
      component: resolve => require(['@/views/user/ResetEmailTwoView.vue'], resolve),
      meta: {
        keepAlive: false,
        requireAuth: true
      }
